...
## Testing
 ...
 ### Performance Testing
  - Tested the site on Google Developer Tools Lighthouse for desktop and mobile with good results on desktop. However mobile has lower performance due to size of the hero image and about us image. My concern with lowering the resolution to boost page load speed is the risk of the image being blurred. Given how mobile performance continues to improve, I dont believe this is a concern. When I first ran the test, accessibility on both desktop and mobile scored 97%, however I went back to amend the hover css property on the nav links for font colour, changing from white to black and setting to bold. There were contrast issues also on the Seasonal Fun and Rainy Day Projects text, with white font colour on yellow and light gray background. Again, I change the text colour to black with an additional hover action of bold font weight. Accessibility score now 100%.
